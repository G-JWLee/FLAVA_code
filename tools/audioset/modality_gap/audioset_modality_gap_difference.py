...
if __name__=='__main__':
    ...
    method_dir = os.path.join(base_path, 'FLAVA_code/experiments/tblogs/cav_base_audioset_pretrain/cav_base_audioset_pretrain')
    ...
    bar_plot(modality_gap_dff_dfs, 'AudioSet Modality Gap Difference', 'modality_gap_difference', palettes)
