...
mdl_weight = torch.load(os.path.join(base_path, 'FLAVA_code/baseline_ckpt/mae_pretrain_vit_base_full.pth'))['model']
...
torch.save(mae_mdl.state_dict(), os.path.join(base_path, 'FLAVA_code/baseline_ckpt/ori_mae_{:d}_for_pretrain_tvlt_like_no_avm_1024.pth'.format(modal_specific_layer)))