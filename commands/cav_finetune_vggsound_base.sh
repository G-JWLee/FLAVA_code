...
criterion=va_cls \
criterion.args.load_local_path=${home_path}/FLAVA_code/experiments/checkpoints/cav_base_vggsound_pretrain/cav_base_vggsound_pretrain_${pretrain_path}/${pretrain_dataset}/model_checkpoint_0010.pth \
...
logging.eval_freq=1 \
logging.name=cav_base_vggsound_finetune_head \
